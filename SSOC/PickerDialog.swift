...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", options: [[String: String]], selected: String? = nil, callback: PickerCallback) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(PickerDialog.deviceOrientationDidChange(_:)), name: UIDeviceOrientationDidChangeNotification, object: nil)
    ...
    private func createContainerView() -> UIView {
        ...
        self.picker.setValue(uicolorFromHex(0x333333), forKeyPath: "textColor")
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.addTarget(self, action: #selector(PickerDialog.buttonTapped(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.doneButton.addTarget(self, action: #selector(PickerDialog.buttonTapped(_:)), forControlEvents: UIControlEvents.TouchUpInside)
